...
public class FeedParser {
	...
	private Entry readEntry(XmlPullParser parser)
		...
		return new Entry(id, title, link, updatedOn, category, content, image);
	}
	...
	private String readTag(XmlPullParser parser, int tagType)
		...
		switch (tagType) {
			...
			case TAG_CATEGORY:
				return readAlternateLink(parser, TAG_CATEGORY);
			case TAG_CONTENT:
				return readBasicTag(parser, "content");
			case TAG_IMAGE:
				return readAlternateLink(parser, TAG_IMAGE);
			case TAG_LINK:
				return readAlternateLink(parser, TAG_LINK);
			default:
	 ...
	 */
	private String readAlternateLink(XmlPullParser parser, int tag)
			throws IOException, XmlPullParserException {
		String content = null;
		switch (tag) {
			case TAG_LINK:
				parser.require(XmlPullParser.START_TAG, ns, "link");
				content = parser.getAttributeValue(null, "href");
				break;
			case TAG_CATEGORY:
				parser.require(XmlPullParser.START_TAG, ns, "category");
				content = parser.getAttributeValue(null, "term");
				break;
			case TAG_IMAGE:
